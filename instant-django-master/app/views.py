...
from .models import Parking_Information
...
# 新規登録処理　#メモ：画面で入力された値を受け取り、テーブルにレコードを作成する
def NewRegist(request):
    ...
    Parking_Information_1 = Parking_Information(pa_code='a')

    # 駐車場情報テーブルにレコードを作成する
    Parking_Information_1.save()
